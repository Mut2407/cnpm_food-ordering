...
public class OrderService {
    ...
    /**
     * Phương thức deleteOrder bạn đang thiếu.
     * Thêm phương thức mới để xóa (soft delete) đơn hàng.
     */
    public void deleteOrder(Integer orderId) {
        ...
        order.setStatus(Order.OrderStatus.CANCELLED); // Cập nhật trạng thái
        orderRepository.save(order);
        
        logger.info("Order with id: {} has been soft deleted (cancelled).", orderId);
    }
